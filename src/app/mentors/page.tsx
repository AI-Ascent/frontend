        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
          <div className="space-y-4">
            <div>
              ...
              >
                <option value={1}>1 Mentor</option>
                <option value={2}>2 Mentors</option>
                <option value={3}>3 Mentors</option>
                <option value={5}>5 Mentors</option>
                <option value={10}>10 Mentors</option>
              </select>
            </div>
